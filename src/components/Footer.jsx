...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+234-906-779-4780", path: '/', icon: MailIcon },
                { text: "emmanueljunior@gmail.com", path: '/', icon: PhoneIcon },
    ...
    return (
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link to="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">go</span>cart<span 
                            className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-102.5 mt-6 text-sm">Welcome to gocart, your ultimate 
                            destination for the latest and smartest gadgets. From smartphones and 
                            smartwatches to essential accessories, we bring you the best in innovation — 
                            all in one place.</p>
                        <div className="flex items-center gap-3 mt-5">
                            {socialIcons.map((item, i) => (
                                <Link to={item.link} key={i} className="flex items-center justify-center 
                                w-10 h-10 bg-slate-100 hover:scale-105 hover:border border-slate-300 
