...
const Banner = () => {
  ...
  return isOpen && (
    <div className="w-full px-6 py-1 font-medium text-sm 
    text-white text-center bg-linear-to-r from-violet-500 
    via-[#9938CA] to-[#E0724A]">
      ...
      max-w-7xl mx-auto'>
        ...
        <div className="flex items-center space-x-6">
          ...
          px-7 py-2 rounded-full max-sm:hidden">
            Claim Offer
          </button>
          <button onClick={() => setIsOpen(false)} 
          type="button" className="font-normal text-gray-800 
          py-2 rounded-full">
